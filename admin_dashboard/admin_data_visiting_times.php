...
$stmt = $conn->prepare("SELECT DATE_FORMAT(STR_TO_DATE(date_time, '%d%m%Y %H:%i'), '%H') AS time,
...
$stmt->bind_result($time, $mid1_tickets, $mid2_tickets, $mid3_tickets, $mid4_tickets);
